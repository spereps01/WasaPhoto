...
type AppDatabase interface {
	SetUsername(u User) (string, error)
	...
	RemoveLike(owner_id int, id_photo int) (string, error)

	FollowUser(id1 int, id2 int) (string, error)

	UnfollowUser(id1 int, id2 int) (string, error)

	BanUser(idu int, idb int) (string, error)
